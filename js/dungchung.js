...
function addHeader() {
	...
	<div class="header group">
        <div class="logo">
            <a href="index.html">
                <img src="img/logo.png" alt="Trang chủ Smartphone Store" title="Trang chủ Khánh Linh Store">
            </a>
        </div> <!-- End Logo -->
...
function addFooter() {
    ...
    <div class="copy-right">
        <p><a href="index.html">Khánh Linh Mobile</a> - All rights reserved © 2022 - Designed by
            <span style="color: #eee; font-weight: bold">Khánh Linh - Ctim</span></p>
    </div>`);
}
